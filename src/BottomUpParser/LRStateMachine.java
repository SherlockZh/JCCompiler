...
public class LRStateMachine {
    ...
    private HashMap<Integer, HashMap<Integer, STATE_MACHINE_ACTION>> stateMachine = new HashMap<>();

    public LRStateMachine(){
        HashMap<Integer, STATE_MACHINE_ACTION> row0 = new HashMap<>();
        ...
        HashMap<Integer, STATE_MACHINE_ACTION> row1 = new HashMap<>();
        ...
        HashMap<Integer, STATE_MACHINE_ACTION> row2 = new HashMap<>();
        ...
        HashMap<Integer, STATE_MACHINE_ACTION> row3 = new HashMap<>();
        ...
        HashMap<Integer, STATE_MACHINE_ACTION> row4 = new HashMap<>();
        ...
        HashMap<Integer, STATE_MACHINE_ACTION> row5 = new HashMap<>();
